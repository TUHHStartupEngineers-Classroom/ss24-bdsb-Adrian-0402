...
acquisition_data <- vroom(
  file       = "~/GitHub/ss24-bdsb-Adrian-0402/source_data/loan_data/Acquisition_2019Q1.txt", 
  delim      = "|", 
...
performance_data <- vroom(
  file       = "~/GitHub/ss24-bdsb-Adrian-0402/source_data/loan_data/Performance_2019Q1.txt", 
  delim      = "|", 
...
tic()
combined_data[current_loan_delinquency_status >= 1, max(current_loan_delinquency_status), by = loan_id][
